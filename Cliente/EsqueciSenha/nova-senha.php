...
Entre a tela de login e esta, uma confirmação de codigo enviado para o email ou numero de Telefone
informado será gerado, para a segunrança na recuperação de senha.
...
<body class="color-A03">
    ...
    <div class="container font-color-B01" id="titulos">
        ...
        <p>Olá Kihan, encontramos suas informações com sucesso.</p>
