...
<head>
  ...
  <!-- CSS GERAL DA ABA DE CONSULTAR DADOS -->
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a href="alterar.php" class="dropdown-item">Alterar dados</a></li>
        ...
        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
          <div class="accordion-body">
            <div class="alert alert-warning" role="alert">
              ...
              <p>
                <strong>Telefone:</strong> 92 99123-4567<br>
                <strong>E-mail:</strong> churracaria.delivery@email.com<br>
                <strong>Senha:</strong> *********
              </p>
            </div>
          </div>
      ...
      <div class="accordion-item">
        ...
        <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
          <div class="accordion-body">
            <div class="alert alert-warning" role="alert">
              <p>
                <strong>Bairro:</strong> Algum bairro ai<br>
                <strong>Rua:</strong> Alguma rua ai<br>
                <strong>Número:</strong> 658<br>
